...
inputs = {
  ...
  policy_description = "Policy to allow aws-load-balancer-controller access to ec2 load balancers"
  role_description   = "IAM role to allow aws-load-balancer-controller access to ec2 load balancers"
